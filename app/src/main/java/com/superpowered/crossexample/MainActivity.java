...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Runtime.getRuntime().exec("chmod -R 777 " + getFilesDir().getAbsolutePath());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                        System.out.println("Save : " + Save(getFilesDir().getAbsolutePath()+"/4.mp3",getFilesDir().getAbsolutePath()+"/0.mp3",getFilesDir().getAbsolutePath()+"/save.wav"));
    ...
    private native boolean Save(String path,String path1,String path2);
